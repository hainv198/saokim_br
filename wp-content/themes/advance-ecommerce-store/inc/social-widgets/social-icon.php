...
class Advance_Ecommerce_Store_Social_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        if(!empty($facebook) ){ ?><a class="custom_facebook fff me-2" href=" <?php echo esc_url($instance['facebook']); ?>"><i class="fab fa-facebook-f me-2 p-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Facebook','advance-ecommerce-store' );?></span></a><?php } ?>

        <?php if(!empty($twitter) ){ ?><a class="custom_twitter me-2" href="<?php echo esc_url($instance['twitter']); ?>"><i class="fab fa-twitter me-2 p-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Twitter','advance-ecommerce-store' );?></span></a><?php } ?>

        <?php if(!empty($linkedin) ){ ?><a class="custom_linkedin me-2" href="<?php echo esc_url($instance['linkedin']); ?>"><i class="fab fa-linkedin-in me-2 p-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Linkedin','advance-ecommerce-store' );?></span></a><?php } ?>

        <?php if(!empty($pinterest) ){ ?><a class="custom_pinterest me-2" href="<?php echo esc_url($instance['pinterest']); ?>"><i class="fab fa-pinterest-p me-2 p-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Pinterest','advance-ecommerce-store' );?></span></a><?php } ?>

        <?php if(!empty($tumblr) ){ ?><a class="custom_tumblr me-2" href="<?php echo esc_url($instance['tumblr']); ?>"><i class="fab fa-tumblr me-2 p-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Tumblr','advance-ecommerce-store' );?></span></a><?php } ?>

        <?php if(!empty($instagram) ){ ?><a class="custom_instagram me-2" href="<?php echo esc_url($instance['instagram']); ?>"><i class="fab fa-instagram me-2 p-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Instagram','advance-ecommerce-store' );?></span></a><?php } ?>

        <?php if(!empty($youtube) ){ ?><a class="custom_youtube me-2" href="<?php echo esc_url($instance['youtube']); ?>"><i class="fab fa-youtube me-2 p-2"></i><span class="screen-reader-text"><?php esc_html_e( 'Youtube','advance-ecommerce-store' );?></span></a><?php } ?>
        <?php echo '</div>';
		?>
		</div>
		<?php
