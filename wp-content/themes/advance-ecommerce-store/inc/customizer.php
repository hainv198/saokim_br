...
function advance_ecommerce_store_customize_register($wp_customize) {
	...
	$wp_customize->add_section('advance_ecommerce_store_product_sale_section', array(
		'title'    => __('Product Sale Button Settings', 'advance-ecommerce-store'),
		'priority' => null,
		'panel'    => 'woocommerce',
	));
	...
	$wp_customize->add_control('advance_ecommerce_store_align_product_sale',array(
        ...
        'section' => 'advance_ecommerce_store_product_sale_section',
        'choices' => array(
    ...
    $wp_customize->add_setting( 'advance_ecommerce_store_loader_background_color_settings', array(
	    'default' => '#222',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'advance_ecommerce_store_loader_background_color_settings', array(
  		'label' => __('Preloader Background Color', 'advance-ecommerce-store'),
	    'section' => 'advance_ecommerce_store_left_right',
	    'settings' => 'advance_ecommerce_store_loader_background_color_settings',
  	)));
