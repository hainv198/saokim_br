...
function supermart_ecommerce_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('supermart_ecommerce_slider_color', array(
		'default' => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'supermart_ecommerce_slider_color', array(
		'label' => __('Theme Primary Color', 'supermart-ecommerce'),
		'section' => 'supermart_ecommerce_slider_section',
	)));
	...
	$wp_customize->add_section('supermart_ecommerce_product_section',array(
		...
		'description'=> __('Note : This section will appear below the slider.','supermart-ecommerce'),
		'panel' => 'supermart_ecommerce_panel_id',
	));
    ...
    $wp_customize->add_section( 'supermart_ecommerce_footer', array(
    	'title'  => __( 'Footer Setting', 'supermart-ecommerce' ),
		'priority' => null,
		'panel' => 'supermart_ecommerce_panel_id'
	) );
	...
	$wp_customize->add_control('supermart_ecommerce_footer_copy',array(
		'label'	=> __('Copyright Text','supermart-ecommerce'),
		'section' => 'supermart_ecommerce_footer',
